...
In particular using ReLU  should improve the training performance of SNNs, since its, to the best of our knowledge, the simplest and most effective activation function.
