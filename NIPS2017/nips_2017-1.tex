...
A small modification is required to use standard activation functions for ANNs, the change is a linear scaling which can be embedded in usual ANN parameters such as the learning rate. %which may be of low computational complexity and their corresponding derivative functions can be directly used for back propagation.
...
%  					\begin{mycell}{1.8cm} 3rd \end{mycell} & 
  					...
  					\begin{mycell}{1.8cm} \textbf{Yes} \end{mycell} &  
  					\begin{mycell}{1.8cm} \textbf{No} \\or fine tune  \end{mycell} & 
  					\begin{mycell}{1.8cm} \textbf{No} \end{mycell} & 
